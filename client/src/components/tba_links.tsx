...
export interface TbaMatchLinkProps {
	event: string;
	matchId: MatchId;
 ...
 *
 */
export function TbaMatchLink(props: TbaMatchLinkProps) {
	const matchPart =
...
export interface TbaTeamLinkProps {
	team: number;
	year: number;
	style?: JSXInternal.CSSProperties;
}
 ...
 *
 */
export function TbaTeamLink(props: TbaTeamLinkProps) {
	const linkUrl = `https://www.thebluealliance.com/team/${props.team}/${props.year}`;
