...
export function MatchEntry() {
	...
	useEffect(() => {
		if (matchId !== undefined && teamId !== undefined) {
			...
			localStorage.setItem("match-" + matchId?.toString() + "-" + teamId?.toString(), JSON.stringify(saveData));
		}
	}, [data]);
	useEffect(() => {
		if (matchId !== undefined && teamId !== undefined) {
			const newData: MatchEntryIdData | null = JSON.parse(localStorage.getItem("match-" + matchId?.toString() + "-" + teamId?.toString()) ?? "null");
			if (newData !== null) {
